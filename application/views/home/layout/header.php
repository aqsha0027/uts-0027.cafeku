...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="<?= base_url() ?>">CafeKU0027</a></h1>
    ...
    <ul>
        ...
        <li><a href="<?= base_url() ?>auth"><i class="bi bi-person-circle"></i> Login</a></li>
        
        <!-- Tambahkan link untuk login di sini -->
