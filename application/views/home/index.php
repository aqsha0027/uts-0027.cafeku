...
<section id="hero">
  <div id="heroCarousel" data-bs-interval="3000" class="carousel slide carousel-fade" data-bs-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <!-- Slide 1 -->
      <div class="carousel-item active" style="background-image: url(<?= base_url() ?>assets/dataresto/foto_usaha/<?= $foto_usaha_1 ?>)"></div>

      <!-- Slide 2 -->
      <div class="carousel-item" style="background-image: url(<?= base_url() ?>assets/dataresto/foto_usaha/<?= $foto_usaha_2 ?>)"></div>

      <!-- Slide 3 -->
      <div class="carousel-item" style="background-image: url(<?= base_url() ?>assets/dataresto/foto_usaha/<?= $foto_usaha_3 ?>)"></div>
...
<main id="main">
  ...
  <section id="about" class="about">
   ...
   <section id="about" class="about">
    <div class="container">
      <div class="section-title">
        <h2>Informasi CafeKU</h2>
        <p>Selamat Datang di CafeKU0027</p>
      </div>
      ...
      <div class="row content">
        <div class="col-lg-6">
          ...
          <ul class="text-left">
            <li><i class="ri-check-double-line"></i>Alamat : Jl. Rahasia no.123</li>
            <li><i class="ri-check-double-line"></i>No Telepon : 088980700515</li>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 icon-box">
          ...
          <p class="description">Pembayaran dapat dibayar melalui E-Money atau transfer antar bank.</p>
        </div>
        <div class="col-lg-4 col-md-6 icon-box">
  ...
  <section id="recent-photos" class="recent-photos">
    <div class="container">
      ...
      <div class="section-title">
        <h2>MENU SPESIAL</h2>
        <p>Menyediakan menu makanan dan minuman yang berkualitas, siapapun kini bisa berwisata kuliner hanya dengan mengunjungi CafeKU0027 Semua yang anda cari ada disini!</p>
      </div>
